...
set CMAKE_OPTIONS=%CMAKE_OPTIONS% -DBoost_DIR=%BOOST_ROOT_DIR:\=/%/lib/cmake/Boost-%BOOST_VERSION%
...
SET CMAKE_OPTIONS=%CMAKE_OPTIONS% -DPY2CPP_ROOT_DIR=%PY2CPP_ROOT_DIR:\=/%
...
SET CMAKE_OPTIONS=%CMAKE_OPTIONS% -DSalomeBootstrap_DIR=%SALOMEBOOTSTRAP_ROOT_DIR:\=/%/__RUN_SALOME__/salome_adm/cmake_files
