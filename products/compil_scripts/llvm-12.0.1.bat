...
set CMAKE_OPTIONS=%CMAKE_OPTIONS% -DLLVM_ENABLE_PROJECTS="clang"
...
set /a "NPROCS=%NUMBER_OF_PROCESSORS% / 2"
set CMAKE_OPTIONS=%CMAKE_OPTIONS% -DCMAKE_CXX_FLAGS="/bigobj /Zm400 /MP%NPROCS%"
