...
copy /Y /B %PRODUCT_INSTALL%\bin\libpng15.dll %PRODUCT_INSTALL%\bin\libpng.dll
copy /Y /B %PRODUCT_INSTALL%\lib\libpng15_static.lib %PRODUCT_INSTALL%\lib\libpng_static.lib
copy /Y /B %PRODUCT_INSTALL%\lib\libpng15.lib %PRODUCT_INSTALL%\lib\libpng.lib