...
python configure.py --confirm-license --no-designer-plugin --bindir=%PRODUCT_INSTALL%\bin --destdir=%PRODUCT_INSTALL%\lib\%python_name%\site-packages --sipdir=%PRODUCT_INSTALL%\sip --spec=win32-msvc2010 --sip-incdir=%sip_incdir% --pyuic5-interpreter=%python_exe% --disable QtNfc 2>&1
if NOT %ERRORLEVEL% == 0 (
