...
CALL:MODULE_BUILDER openturns "%SOURCE_DIR%\openturns-1.23" "%BUILD_DIR%\openturns" "%PRODUCT_INSTALL%" "%CMAKE_MODULE_OPTIONS%"
...
echo ##########################################################################
SET CMAKE_MODULE_OPTIONS=%CMAKE_OPTIONS%
CALL:MODULE_BUILDER otmorris "%SOURCE_DIR%\otmorris-0.16" "%BUILD_DIR%\otmorris" "%PRODUCT_INSTALL%" "%CMAKE_MODULE_OPTIONS%"

echo ##########################################################################
echo otfftw 0.15
echo ##########################################################################
SET CMAKE_MODULE_OPTIONS=%CMAKE_OPTIONS%
CALL:MODULE_BUILDER otfftw "%SOURCE_DIR%\otfftw-0.15" "%BUILD_DIR%\otfftw" "%PRODUCT_INSTALL%" "%CMAKE_MODULE_OPTIONS%"
...
CALL:MODULE_BUILDER otrobopt "%SOURCE_DIR%\otrobopt-0.14" "%BUILD_DIR%\otrobopt" "%PRODUCT_INSTALL%" "%CMAKE_MODULE_OPTIONS%"
...
echo ##########################################################################
SET CMAKE_MODULE_OPTIONS=%CMAKE_OPTIONS% -DBUILD_DOC=OFF
CALL:MODULE_BUILDER otsvm "%SOURCE_DIR%\otsvm-0.14" "%BUILD_DIR%\otsvm" "%PRODUCT_INSTALL%" "%CMAKE_MODULE_OPTIONS%"
...
cd  %BUILD_DIR%\otfmi
xcopy %SOURCE_DIR%\otfmi-0.16.3\*   %BUILD_DIR%\otfmi /E /I /Q
if NOT %ERRORLEVEL% == 0 (
    echo ERROR on xcopy
    exit 3
)
