...
set CMAKE_OPTIONS=%CMAKE_OPTIONS% -DPARAVIEW_VERSIONED_INSTALL:BOOL=OFF
...
set CMAKE_OPTIONS=%CMAKE_OPTIONS% -DVTK_INSTALL_LIBRARY_DIR=lib/paraview
set CMAKE_OPTIONS=%CMAKE_OPTIONS% -DVTK_INSTALL_ARCHIVE_DIR=lib/paraview
...
set CMAKE_OPTIONS=%CMAKE_OPTIONS% -DPARAVIEW_PLUGIN_ENABLE_XArrayCFReader=OFF
...
IF DEFINED ONNX_ROOT_DIR (
  set CMAKE_OPTIONS=%CMAKE_OPTIONS% -DPARAVIEW_PLUGIN_ENABLE_ONNXPlugin:BOOL=ON
) ELSE (
